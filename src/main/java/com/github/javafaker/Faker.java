...
public class Faker {
    ...
    public Faker() {
        this(Locale.ENGLISH, RandomUtils.JVM_RANDOM);
    }
    public Faker(Locale locale) { this(locale, RandomUtils.JVM_RANDOM); }
    public Faker(Random random) { this(Locale.ENGLISH, random); }
